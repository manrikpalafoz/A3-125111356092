...
public class TeladeJogadaRede extends JFrame{
	...
	private static int escolha02=-2;
	private ThreadConexao thread; 
	private static String nomeP1 = "Player 1", nomeP2 = "Player 2";
	...
	public TeladeJogadaRede (String _nome) {
		...
		lblVitorias.setBounds(306, 55, 19, 45);
		...
		txtVitPlayer1.setBounds(229, 67, 53, 29);
		...
		txtVitPlayer2.setBounds(347, 67, 53, 29);
		...
		rbtnImpar = new JToggleButton("IMPAR");
